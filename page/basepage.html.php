        ...
        <div class="container-fluid bg-dark">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0 ">
                    <li class="nav-item">
                        <a class="nav-link text-light fw-light" aria-current="page" href="index.php">Accueil <i
                                class="fa fa-home"></i></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fw-light" href="collaborator.php">Collaborateur <i
                                class="fa fa-people-group"></i></a>
                    </li>
                </ul>
